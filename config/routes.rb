Rails.application.routes.draw do
 ...
 # get 'tutorials/tutorial_post'
  ...
  get 'get_monthly_summary/:user_id'            => 'api#get_monthly_summary', as: 'get_monthly_summary'
    ...
    post 'checkout_subscription_credit_card_paypal' => 'orders#checkout_subscription_credit_card_paypal', as: 'checkout_subscription_credit_card_paypal'
  ...
  get 'feed.rss' => 'feeds#rss', as: 'rss_feeds'
