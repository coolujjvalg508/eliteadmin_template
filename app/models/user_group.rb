...
validates :name, presence: true
 MODULESTOPERMIT = ['gallery','category', 'mediumcategory', 'subjectmatter', 'job','jobcategory', 'package','advertisementpackage','news_category', 'news','newsletter_setting', 'staticpage','advertisement','faq', 'sitesetting', 'tag', 'tutorial','jobskill','categorytype','softwareexpertise','adminuser', 'user','usergroup','widget','comment','topic','tutorial','message','menu','questionaire','challenge','company','invitation','download','post_type_category','post_type','image_library','video_library','upload_video_library','zip_library','systememail']
