ActiveAdmin.register Job do
	...
	:work_remotely, :relocation_asistance, :closing_date, :skill, 
	:software_expertise, :tags, :use_tag_from_previous_upload, :is_featured, :status, 
	...
	form multipart: true do |f|
		...
		f.inputs "Job" do
		  ...
		  f.input :job_type, as: :select, collection: [['Freelance',1]], include_blank: false
		  f.input :from_amount,label:'From Amount'
		  f.input :to_amount,label:'To Amount'
		  f.input :job_category,label:'Job Category'
		  ...
		  f.input :skill, label:'Skills and expertise'
		  f.input :software_expertise, label:'Software Expertise'
