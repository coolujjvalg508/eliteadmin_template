	...
	controller do 
			def action_methods
			 super                                    
				...
				disallowed = []
				disallowed << 'index' if (!usergroup.has_permission('video_library_read') && !usergroup.has_permission('video_library_write') && !usergroup.has_permission('video_library_delete'))
				disallowed << 'delete' unless (usergroup.has_permission('video_library_delete'))
				disallowed << 'create' unless (usergroup.has_permission('video_library_write'))
				disallowed << 'new' unless (usergroup.has_permission('video_library_write'))
				disallowed << 'edit' unless (usergroup.has_permission('video_library_write'))
				disallowed << 'destroy' unless (usergroup.has_permission('video_library_delete'))
